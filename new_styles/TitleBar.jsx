  ...
  return (
    <>
      ...
      <div id="custom-titlebar">
        ...
        <div id="tb-controls">
          {/* Minimize */}
          <button className="tb-btn" onClick={minimize} title="Kichraytirish">
          ...
          {/* Maximize / Restore */}
          <button className="tb-btn" onClick={maximize} title={isMaximized ? 'Tiklash' : 'Kattalashtirish'}>
            {isMaximized ? (
              <svg viewBox="0 0 12 12">
          ...
          {/* Close */}
          <button className="tb-btn tb-btn-close" onClick={close} title="Yopish">
            <svg viewBox="0 0 12 12">
